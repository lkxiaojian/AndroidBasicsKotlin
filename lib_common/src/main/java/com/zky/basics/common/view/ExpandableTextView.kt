...
class ExpandableTextView : LinearLayout, View.OnClickListener {
    ...
    fun setText(
        text: CharSequence?, collapsedStatus: SparseBooleanArray,
        position: Int
    ) {
    ...
    var text: CharSequence?
        ...
        set(text) {
            ...
            mTv!!.text = text
            visibility =
                if (TextUtils.isEmpty(text)) GONE else VISIBLE
            clearAnimation()
    ...
    internal inner class ImageButtonExpandController(
        ...
        override fun showView(isshow: Boolean) {
            if (mImageButton != null) {
                Handler().post {
                    ...
                    mImageButton!!.visibility = if (isshow) VISIBLE else GONE
                }
            }
        }
    }
